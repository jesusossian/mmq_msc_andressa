...
def main():
	...
	objval, objbound, mgap, rtime, ncount, tmp = opt.lsr_std_math_mip(N, PP, PR, FP, FR, HP, HR, D, R, SD, SR, yp_val, yr_val)
	arquivo = open(os.path.join(result_path,'lsr_std_math_mip.txt'),'a')
